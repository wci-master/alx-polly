...
/**
 * Creates a toast notification with the specified properties.
 * 
 * @param props - The properties for the toast
 * @returns An object with methods to control the toast
 */
 ...
 * 
 * @returns An object with toast state and methods
 */
function useToast() {
